        ...
        case 'create_user':
            ...
            if ($ins->execute()) {
                ...
                $mailBody = '<div style="font-family:Arial,sans-serif;max-width:500px;margin:0 auto;">'
                    ...
                    . '<p>Hello, your admin-created account is ready. Here are your credentials:</p>'
                    . '<table style="width:100%;border-collapse:collapse;margin:16px 0;">'
                    . '<tr><td style="padding:8px;font-weight:bold;border-bottom:1px solid #eee;">ID Number</td><td style="padding:8px;border-bottom:1px solid #eee;">' . htmlspecialchars($idNo) . '</td></tr>'
