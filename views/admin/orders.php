...
<body class="admin-body">
    <aside class="admin-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a onclick="getAdminOrders()" class="sidebar-link active"><i class="fa-solid fa-bag-shopping"></i><span>Orders</span><?php if ($orderCount > 0): ?><span class="sidebar-badge"><?php echo $orderCount; ?></span><?php endif; ?></a>
